...
void test_Image::getProjectionLabelFromPlaneOrientation_ShouldReturnNAOrEmpty_data()
{
...
void test_Image::getProjectionLabelFromPlaneOrientation_ShouldReturnNAOrEmpty()
{
    QFETCH(QString, string);
    QFETCH(QString, result);

    QCOMPARE(Image::getProjectionLabelFromPlaneOrientation(string), result);
}

void test_Image::getProjectionLabelFromPlaneOrientation_ShouldReturnConcretLabel_data()
{
...
void test_Image::getProjectionLabelFromPlaneOrientation_ShouldReturnConcretLabel()
{
    QFETCH(QString, string);
    QFETCH(QString, result);
