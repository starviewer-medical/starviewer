...
using array_d3 = std::array<double, 3>;
Q_DECLARE_METATYPE(array_d3)
...
void test_AutomaticSynchronizationToolData::setPosition_Works_data()
{
    ...
    QTest::addColumn<std::array<double, 3>>("position_1");
    QTest::addColumn<double>("displacement_1");

    QTest::addColumn<QString>("frameOfReferenceUID_2");
    QTest::addColumn<QString>("view_2");
    QTest::addColumn<std::array<double, 3>>("position_2");
    QTest::addColumn<double>("displacement_2");

    std::array<double, 3> position_1{1.0, 2.0, 3.0};
    double displacement1 = 2.6;
    std::array<double, 3> position_2{10.0, 20.0, 30.0};
...
void test_AutomaticSynchronizationToolData::setPosition_Works()
{
    ...
    std::array<double, 3> savedPosition = toolData->getPosition(frameOfReferenceUID_1, view_1);
