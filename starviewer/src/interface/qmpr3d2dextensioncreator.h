 ...
 ***************************************************************************/
#ifndef UDGQMPR3D2DEXTENSIONCREATOR_H
#define UDGQMPR3D2DEXTENSIONCREATOR_H
...
*/
class QMPR3D2DExtensionCreator : public ExtensionCreator{
Q_OBJECT
public:
    QMPR3D2DExtensionCreator(QObject *parent = 0, const char *name = 0);

    ~QMPR3D2DExtensionCreator();
