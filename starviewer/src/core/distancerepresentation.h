...
public:
    ...
    DistanceRepresentation( OldDistanceToolData *dtd );
...
//     void setPolygon( Polygon *polygon );
    ...
    ///assignem un objecte de tipus OldDistanceToolData
    void setDistanceToolData( OldDistanceToolData *dtd );
...
//     Polygon* getPolygon();
    ...
    ///ens retorna l'atribut de tipus OldDistanceToolData
    OldDistanceToolData* getDistanceToolData();
...
//     { m_polygon->refreshPolygon(); }
    ...
    ///fa que l'atribut OldDistanceToolData calculi el text de la distància i la posició del mateix
...
//     Polygon *m_polygon;
    ...
    ///atribut del tipus OldDistanceToolData per tal de guardar dades referents a la distància
    OldDistanceToolData *m_distanceToolData;
};
