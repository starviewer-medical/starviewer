...
public:
    ...
    /// Li assignem la vista del visor
    void setView(int view);

    /// Activa / Desactiva el reverse Stencil
    void setReverseStencilOn();
    void setReverseStencilOff();

    /// Assigna com a color de fons el transparent
    ...
    ///@param vertexs: QList de double[3] (3D)
    void setPolygonalShutter(QList<double *> vertexs);
...
private:
    ...
    /// Estableix quina part de la figura es retalla: interior / exterior
