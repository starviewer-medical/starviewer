...
OldScreenShotTool::OldScreenShotTool( Q2DViewer *viewer, QObject *parent )
{
...
OldScreenShotTool::OldScreenShotTool( Q3DViewer *viewer, QObject *parent )
{
    m_windowToImageFilter = vtkWindowToImageFilter::New();
    if( viewer )
    {
...
OldScreenShotTool::OldScreenShotTool( Q3DMPRViewer *viewer, QObject *parent )
{
    m_windowToImageFilter = vtkWindowToImageFilter::New();
    if( viewer )
    {
...
OldScreenShotTool::~OldScreenShotTool()
{
}

void OldScreenShotTool::handleEvent( unsigned long eventID )
{
    switch( eventID )
    {
...
void OldScreenShotTool::screenShot()
{
