...
void OldWindowLevelTool::handleEvent( unsigned long eventID )
{
    switch( eventID )
    {
...
void OldWindowLevelTool::startWindowLevel()
{
    if( m_2DViewer )
    {
...
void OldWindowLevelTool::doWindowLevel()
{
    if( m_2DViewer )
    {
...
void OldWindowLevelTool::endWindowLevel()
{
    if( m_2DViewer )
        m_state = NONE;
    else
