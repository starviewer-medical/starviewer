...
public:
    ...
    TranslateTool( Q2DViewer *viewer , QObject *parent = 0, QString name = 0 );
    TranslateTool( Q3DViewer *viewer , QObject *parent = 0, QString name = 0 );
    TranslateTool( Q3DMPRViewer *viewer , QObject *parent = 0, QString name = 0 );
