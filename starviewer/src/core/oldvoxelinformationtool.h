 ...
 ***************************************************************************/
#ifndef UDGOLDVOXELINFORMATIONTOOL_H
#define UDGOLDVOXELINFORMATIONTOOL_H
...
*/
class OldVoxelInformationTool : public OldTool
{
Q_OBJECT
public:
    OldVoxelInformationTool( Q2DViewer *viewer, QObject *parent = 0 );

    ~OldVoxelInformationTool();
