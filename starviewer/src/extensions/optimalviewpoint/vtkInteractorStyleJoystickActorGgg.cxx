...
vtkCxxRevisionMacro(vtkInteractorStyleJoystickActorGgg, "$Revision: 1.31 $");
vtkStandardNewMacro(vtkInteractorStyleJoystickActorGgg);

//----------------------------------------------------------------------------
vtkInteractorStyleJoystickActorGgg::vtkInteractorStyleJoystickActorGgg() 
{
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::OnMouseMove() 
{
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::OnLeftButtonDown() 
{
  int x = this->Interactor->GetEventPosition()[0];
  int y = this->Interactor->GetEventPosition()[1];
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::OnLeftButtonUp() 
{
  switch (this->State) 
    {
    case VTKIS_PAN:
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::OnMiddleButtonDown() 
{
  int x = this->Interactor->GetEventPosition()[0];
  int y = this->Interactor->GetEventPosition()[1];
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::OnMiddleButtonUp() 
{
  switch (this->State) 
    {
    case VTKIS_DOLLY:
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::OnRightButtonDown() 
{
  int x = this->Interactor->GetEventPosition()[0];
  int y = this->Interactor->GetEventPosition()[1];
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::OnRightButtonUp() 
{
  switch (this->State) 
    {
    case VTKIS_USCALE:
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::Rotate()
{
  if ( this->CurrentRenderer == NULL || this->InteractionProp == NULL )
    {
    return;
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::Spin()
{
  if ( this->CurrentRenderer == NULL || this->InteractionProp == NULL )
    {
    return;
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::Pan()
{
  if (this->CurrentRenderer == NULL || this->InteractionProp == NULL)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::Dolly()
{
  if (this->CurrentRenderer == NULL || this->InteractionProp == NULL)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::UniformScale()
{
  if (this->CurrentRenderer == NULL || this->InteractionProp == NULL)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os,indent);
}

//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::FindPickedActor(int x, int y)
{
...
//----------------------------------------------------------------------------
void vtkInteractorStyleJoystickActorGgg::Prop3DTransform(vtkProp3D *prop3D,
                                                      double *boxCenter,
                                                      int numRotation,
                                                      double **rotate,
                                                      double *scale)
