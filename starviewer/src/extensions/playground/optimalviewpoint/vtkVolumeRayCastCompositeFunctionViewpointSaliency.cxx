/*=========================================================================
  ...
  Module:    $RCSfile: vtkVolumeRayCastCompositeFunctionViewpointSaliency.cxx,v $
...
vtkCxxRevisionMacro(vtkVolumeRayCastCompositeFunctionViewpointSaliency, "$Revision: 1.1 $");
vtkStandardNewMacro(vtkVolumeRayCastCompositeFunctionViewpointSaliency);
...
void vtkCastRay_NN_Unshaded( T *data_ptr, vtkVolumeRayCastDynamicInfo *dynamicInfo,
                          vtkVolumeRayCastStaticInfo *staticInfo, double * aSaliency, udg::OptimalViewpointVolume * aVolume )
{
  int             value=0;
  ...
  if ( staticInfo->ColorChannels == 1 ) 
    ...
    for ( loop = 0; 
      ...
      accum_red_intensity   += ( opacity * remaining_opacity *
                                 GTF[(value)] );
      //////////////////////////////////////////////////////////////////////////////////////////////
      pixelSaliency += ( opacity * remaining_opacity * aSaliency[offset] );
      //////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  if ( pixelSaliency > 0.0 )
    aVolume->accumulateViewpointSaliency( vtkMultiThreader::GetCurrentThreadID(), pixelSaliency );
  //////////////////////////////////////////////////////////////////////////////////////////////////
                                       ...
                                       vtkVolumeRayCastStaticInfo *staticInfo, double * aSaliency, udg::OptimalViewpointVolume * aVolume )
{
  ...
  if ( staticInfo->ColorChannels == 1 ) 
    ...
    for ( loop = 0; 
      ...
      //////////////////////////////////////////////////////////////////////////////////////////////
      double saliency = aSaliency[offset       ] * t1 * t2 * t3
                      + aSaliency[offset + Binc] *  x * t2 * t3
                      + aSaliency[offset + Cinc] * t1 *  y * t3
                      + aSaliency[offset + Dinc] *  x *  y * t3
                      + aSaliency[offset + Einc] * t1 * t2 *  z
                      + aSaliency[offset + Finc] *  x * t2 *  z
                      + aSaliency[offset + Ginc] * t1 *  y *  z
                      + aSaliency[offset + Hinc] *  x *  y *  z;
      //////////////////////////////////////////////////////////////////////////////////////////////
      ...
      if ( opacity )
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        pixelSaliency += ( opacity * remaining_opacity * saliency );
        ////////////////////////////////////////////////////////////////////////////////////////////
        remaining_opacity *= (1.0 - opacity);
        }
                                     ...
                                     vtkVolumeRayCastStaticInfo *staticInfo, double * aSaliency, udg::OptimalViewpointVolume * aVolume )
{
  ...
  if ( staticInfo->ColorChannels == 1 ) 
    ...
    for ( loop = 0; 
      ...
      //////////////////////////////////////////////////////////////////////////////////////////////
      double saliency = aSaliency[offset       ] * tA
                      + aSaliency[offset + Binc] * tB
                      + aSaliency[offset + Cinc] * tC
                      + aSaliency[offset + Dinc] * tD
                      + aSaliency[offset + Einc] * tE
  ...
  if ( staticInfo->ColorChannels == 1 ) 
    ...
    for ( loop = 0; 
      ...
      if ( A && Ago )
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        saliency += weight * aSaliency[offset];
        ////////////////////////////////////////////////////////////////////////////////////////////
        }
      ...
      if ( B && Bgo )
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        saliency += weight * aSaliency[offset + Binc];
        ////////////////////////////////////////////////////////////////////////////////////////////
        }
      ...
      if ( C && Cgo )
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        saliency += weight * aSaliency[offset + Cinc];
        ////////////////////////////////////////////////////////////////////////////////////////////
        }
      ...
      if ( D && Dgo )
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        saliency += weight * aSaliency[offset + Dinc];
        ////////////////////////////////////////////////////////////////////////////////////////////
        }
      ...
      if ( E && Ego )
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        saliency += weight * aSaliency[offset + Einc];
        ////////////////////////////////////////////////////////////////////////////////////////////
        }
      ...
      if ( F && Fgo )
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        saliency += weight * aSaliency[offset + Finc];
        ////////////////////////////////////////////////////////////////////////////////////////////
        }
      ...
      if ( G && Ggo )
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        saliency += weight * aSaliency[offset + Ginc];
        ////////////////////////////////////////////////////////////////////////////////////////////
        } 
      ...
      if ( H && Hgo )
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        saliency += weight * aSaliency[offset + Hinc];
        ////////////////////////////////////////////////////////////////////////////////////////////
        }
      ...
      accum_red_intensity   += remaining_opacity * red_value;
      //////////////////////////////////////////////////////////////////////////////////////////////
      pixelSaliency += remaining_opacity * saliency;
      //////////////////////////////////////////////////////////////////////////////////////////////
      remaining_opacity *= (1.0 - opacity);
...
// Constructor for the vtkVolumeRayCastCompositeFunctionViewpointSaliency class
vtkVolumeRayCastCompositeFunctionViewpointSaliency::vtkVolumeRayCastCompositeFunctionViewpointSaliency()
{
...
// Destruct the vtkVolumeRayCastCompositeFunctionViewpointSaliency
vtkVolumeRayCastCompositeFunctionViewpointSaliency::~vtkVolumeRayCastCompositeFunctionViewpointSaliency()
{
}
...
// to call.
void vtkVolumeRayCastCompositeFunctionViewpointSaliency::CastRay( vtkVolumeRayCastDynamicInfo *dynamicInfo,
  ...
  if ( staticInfo->InterpolationType == VTK_NEAREST_INTERPOLATION )
    ...
    if ( staticInfo->Shading == 0 )
      ...
      switch ( staticInfo->ScalarDataType )
        {
        case VTK_UNSIGNED_CHAR:
          vtkCastRay_NN_Shaded( (unsigned char *)data_ptr, dynamicInfo, staticInfo, Saliency, Volume );
          break;
        case VTK_UNSIGNED_SHORT:
          vtkCastRay_NN_Shaded( (unsigned short *)data_ptr, dynamicInfo, staticInfo, Saliency, Volume );
          break;
        default:
          vtkWarningMacro ( << "Unsigned char and unsigned short are the only supported datatypes for rendering" );
          break;
        ...
        switch ( staticInfo->ScalarDataType )
          ...
          case VTK_UNSIGNED_CHAR:
            vtkCastRay_TrilinSample_Unshaded( (unsigned char *)data_ptr,
                                              dynamicInfo, staticInfo, Saliency, Volume );
            break;
          case VTK_UNSIGNED_SHORT:
...
float vtkVolumeRayCastCompositeFunctionViewpointSaliency::GetZeroOpacityThreshold( vtkVolume
                                                                  *vol )
{
...
void vtkVolumeRayCastCompositeFunctionViewpointSaliency::SpecificFunctionInitialize(
...
const char *vtkVolumeRayCastCompositeFunctionViewpointSaliency::GetCompositeMethodAsString(void)
{
  if( this->CompositeMethod == VTK_COMPOSITE_INTERPOLATE_FIRST )
    {
...
// Print method for vtkVolumeRayCastCompositeFunctionViewpointSaliency
// Since there is nothing local to print, just print the object stuff.
void vtkVolumeRayCastCompositeFunctionViewpointSaliency::PrintSelf(ostream& os, vtkIndent indent)
{
