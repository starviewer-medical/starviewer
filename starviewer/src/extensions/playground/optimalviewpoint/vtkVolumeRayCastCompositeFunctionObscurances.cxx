/*=========================================================================
  ...
  Module:    $RCSfile: vtkVolumeRayCastCompositeFunctionObscurances.cxx,v $
...
//                                  CTF[(value)*3 + 2] );
      accum_red_intensity   += ( opacity * remaining_opacity * 
                                 CTF[(value)*3] ) * aObscurance[offset];
      accum_green_intensity += ( opacity * remaining_opacity * 
                                 CTF[(value)*3 + 1] ) * aObscurance[offset];
      accum_blue_intensity  += ( opacity * remaining_opacity * 
                                 CTF[(value)*3 + 2] ) * aObscurance[offset];
      //////////////////////////////////////////////////////////////////////////////////////////////
      remaining_opacity *= (1.0 - opacity);
...
// Destruct the vtkVolumeRayCastCompositeFunctionObscurances
vtkVolumeRayCastCompositeFunctionObscurances::~vtkVolumeRayCastCompositeFunctionObscurances()
{
}
...
// to call.
void vtkVolumeRayCastCompositeFunctionObscurances::CastRay( vtkVolumeRayCastDynamicInfo *dynamicInfo,
  ...
  if ( staticInfo->InterpolationType == VTK_NEAREST_INTERPOLATION )
    ...
    if ( staticInfo->Shading == 0 )
      ...
      switch ( staticInfo->ScalarDataType )
        {
        case VTK_UNSIGNED_CHAR:
          vtkCastRay_NN_Shaded( (unsigned char *)data_ptr, dynamicInfo, staticInfo, Obscurance );
          break;
        case VTK_UNSIGNED_SHORT:
          vtkCastRay_NN_Shaded( (unsigned short *)data_ptr, dynamicInfo, staticInfo, Obscurance );
          break;
        default:
          vtkWarningMacro ( << "Unsigned char and unsigned short are the only supported datatypes for rendering" );
          break;
...
float vtkVolumeRayCastCompositeFunctionObscurances::GetZeroOpacityThreshold( vtkVolume
                                                                  *vol )
{
...
void vtkVolumeRayCastCompositeFunctionObscurances::SpecificFunctionInitialize( 
...
const char *vtkVolumeRayCastCompositeFunctionObscurances::GetCompositeMethodAsString(void)
{
  if( this->CompositeMethod == VTK_COMPOSITE_INTERPOLATE_FIRST )
    {
...
// Print method for vtkVolumeRayCastCompositeFunctionObscurances
// Since there is nothing local to print, just print the object stuff.
void vtkVolumeRayCastCompositeFunctionObscurances::PrintSelf(ostream& os, vtkIndent indent)
{
