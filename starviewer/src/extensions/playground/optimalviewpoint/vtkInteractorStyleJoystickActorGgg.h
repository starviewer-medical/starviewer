...
class vtkInteractorStyleJoystickActorGgg : public vtkInteractorStyle
{
public:
  static vtkInteractorStyleJoystickActorGgg *New();

  vtkTypeRevisionMacro(vtkInteractorStyleJoystickActorGgg,vtkInteractorStyle);
...
private:
  vtkInteractorStyleJoystickActorGgg(const vtkInteractorStyleJoystickActorGgg&);  // Not implemented.
  void operator=(const vtkInteractorStyleJoystickActorGgg&);  // Not implemented.
};
