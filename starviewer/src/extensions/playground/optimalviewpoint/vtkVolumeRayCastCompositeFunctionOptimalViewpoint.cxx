/*=========================================================================
  ...
  Module:    $RCSfile: vtkVolumeRayCastCompositeFunctionOptimalViewpoint.cxx,v $
...
vtkCxxRevisionMacro(vtkVolumeRayCastCompositeFunctionOptimalViewpoint, "$Revision: 1.1 $");
vtkStandardNewMacro(vtkVolumeRayCastCompositeFunctionOptimalViewpoint);
...
template <class T>
void vtkVolumeRayCastCompositeFunctionOptimalViewpoint::vtkCastRay_NN_Unshaded( T *data_ptr, vtkVolumeRayCastDynamicInfo *dynamicInfo,
                          vtkVolumeRayCastStaticInfo *staticInfo )
{
    ////////////////////////////////////////////////////////////////////////////
    int rayId = vtkMultiThreader::GetCurrentThreadID();
    ////////////////////////////////////////////////////////////////////////////
  ...
  if ( staticInfo->ColorChannels == 1 ) 
    ...
    for ( loop = 0; 
          loop < num_steps && ( ( m_computing && !m_opacityOn ) || remaining_opacity > VTK_REMAINING_OPACITY ); //////////////////////////////
          loop++ )
      {     
      ...
      steps_this_ray++;
        ...
        if ( m_computing )
        {
            int cOffset = voxel[2] * zinc + voxel[1] * yinc + voxel[0] * xinc;
            m_optimalViewpointVolume->handle( rayId, cOffset );
        }
        ////////////////////////////////////////////////////////////////////////
  ...
  dynamicInfo->NumberOfStepsTaken = steps_this_ray;
    ...
    ////////////////////////////////////////////////////////////////////////////
    if ( m_computing ) m_optimalViewpointVolume->endRay( rayId );
    ////////////////////////////////////////////////////////////////////////////
}
...
// perform shading.
template <class T>
void vtkVolumeRayCastCompositeFunctionOptimalViewpoint::vtkCastRay_NN_Shaded( T *data_ptr, vtkVolumeRayCastDynamicInfo *dynamicInfo,
                           vtkVolumeRayCastStaticInfo *staticInfo )
{
    ////////////////////////////////////////////////////////////////////////////
    int rayId = vtkMultiThreader::GetCurrentThreadID();
...
template <class T>
void vtkVolumeRayCastCompositeFunctionOptimalViewpoint::vtkCastRay_TrilinSample_Unshaded( T *data_ptr, vtkVolumeRayCastDynamicInfo *dynamicInfo,
                                       vtkVolumeRayCastStaticInfo *staticInfo )
{
    ////////////////////////////////////////////////////////////////////////////
    int rayId = vtkMultiThreader::GetCurrentThreadID();
...
template <class T>
void vtkVolumeRayCastCompositeFunctionOptimalViewpoint::vtkCastRay_TrilinSample_Shaded( T *data_ptr, vtkVolumeRayCastDynamicInfo *dynamicInfo,
                                     vtkVolumeRayCastStaticInfo *staticInfo )
{
    ////////////////////////////////////////////////////////////////////////////
    int rayId = vtkMultiThreader::GetCurrentThreadID();
...
// does not compute shading
template <class T>
void vtkVolumeRayCastCompositeFunctionOptimalViewpoint::vtkCastRay_TrilinVertices_Unshaded( T *data_ptr, vtkVolumeRayCastDynamicInfo *dynamicInfo,
                                         vtkVolumeRayCastStaticInfo *staticInfo )
{
    ////////////////////////////////////////////////////////////////////////////
    int rayId = vtkMultiThreader::GetCurrentThreadID();
...
// does perform shading.
template <class T>
void vtkVolumeRayCastCompositeFunctionOptimalViewpoint::vtkCastRay_TrilinVertices_Shaded( T *data_ptr, vtkVolumeRayCastDynamicInfo *dynamicInfo,
                                       vtkVolumeRayCastStaticInfo *staticInfo )
{
    ////////////////////////////////////////////////////////////////////////////
    int rayId = vtkMultiThreader::GetCurrentThreadID();
...
// Constructor for the vtkVolumeRayCastCompositeFunctionOptimalViewpoint class
vtkVolumeRayCastCompositeFunctionOptimalViewpoint::vtkVolumeRayCastCompositeFunctionOptimalViewpoint()
{
  this->CompositeMethod = VTK_COMPOSITE_INTERPOLATE_FIRST;
}

// Destruct the vtkVolumeRayCastCompositeFunctionOptimalViewpoint
vtkVolumeRayCastCompositeFunctionOptimalViewpoint::~vtkVolumeRayCastCompositeFunctionOptimalViewpoint()
{
}
...
// to call.
void vtkVolumeRayCastCompositeFunctionOptimalViewpoint::CastRay( vtkVolumeRayCastDynamicInfo *dynamicInfo,
                                                 vtkVolumeRayCastStaticInfo *staticInfo )
{
  void *data_ptr;
...
float vtkVolumeRayCastCompositeFunctionOptimalViewpoint::GetZeroOpacityThreshold( vtkVolume 
                                                                  *vol )
{
...
void vtkVolumeRayCastCompositeFunctionOptimalViewpoint::SpecificFunctionInitialize( 
...
const char *vtkVolumeRayCastCompositeFunctionOptimalViewpoint::GetCompositeMethodAsString(void)
{
  if( this->CompositeMethod == VTK_COMPOSITE_INTERPOLATE_FIRST )
    {
...
// Print method for vtkVolumeRayCastCompositeFunctionOptimalViewpoint
// Since there is nothing local to print, just print the object stuff.
void vtkVolumeRayCastCompositeFunctionOptimalViewpoint::PrintSelf(ostream& os, vtkIndent indent)
{
...
void vtkVolumeRayCastCompositeFunctionOptimalViewpoint::setOptimalViewpointVolume( udg::OptimalViewpointVolume * optimalViewpointVolume )
{
    m_optimalViewpointVolume = optimalViewpointVolume;
}


void vtkVolumeRayCastCompositeFunctionOptimalViewpoint::setOpacityOn( bool opacityOn )
{
    m_opacityOn = opacityOn;
}


void vtkVolumeRayCastCompositeFunctionOptimalViewpoint::setComputing( bool on )
{
    m_computing = on;
}
