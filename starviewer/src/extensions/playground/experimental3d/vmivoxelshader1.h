 ...
 */
class VmiVoxelShader1 : public VoxelShader2
{
...
inline HdrColor VmiVoxelShader1::shade( int offset, const Vector3 &direction, double remainingOpacity, const HdrColor &baseColor )
{
    return nvShade( offset, direction, remainingOpacity, baseColor );
}


inline HdrColor VmiVoxelShader1::shade( const Vector3 &position, const Vector3 &direction, const TrilinearInterpolator *interpolator, double remainingOpacity, const HdrColor &baseColor )
{
    return nvShade( position, direction, interpolator, remainingOpacity, baseColor );
}


inline HdrColor VmiVoxelShader1::nvShade( int offset, const Vector3 &direction, double remainingOpacity, const HdrColor &baseColor )
{
    Q_UNUSED( direction );
    Q_UNUSED( baseColor );
...
inline HdrColor VmiVoxelShader1::nvShade( const Vector3 &position, const Vector3 &direction, const TrilinearInterpolator *interpolator, double remainingOpacity, const HdrColor &baseColor )
{
    Q_UNUSED( direction );
    Q_UNUSED( baseColor );
