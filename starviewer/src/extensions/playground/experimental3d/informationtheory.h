...
public:
     ...
     */
    static T kullbackLeiblerDivergence( const QVector<T> &probabilitiesP, const QVector<T> &probabilitiesQ );
    /**
     ...
     */
    static T jensenShannonDivergence( T pi1, T pi2, const QVector<T> &probabilitiesP1, const QVector<T> &probabilitiesP2 );
