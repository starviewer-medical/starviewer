...
static const uint ParallelismFactor = 64;   // quantes entrades hi ha a l'histograma enter per cada valor d'intensitat; ajuda a augmentar el paral·lelisme reduint les col·lisions a l'hora d'escriure
