...
vtkCxxRevisionMacro( vtkVolumeRayCastVoxelShaderCompositeFunction2, "$Revision: 1.0 $" );
vtkStandardNewMacro( vtkVolumeRayCastVoxelShaderCompositeFunction2 );

const float vtkVolumeRayCastVoxelShaderCompositeFunction2::REMAINING_OPACITY = 0.02f;

vtkVolumeRayCastVoxelShaderCompositeFunction2::vtkVolumeRayCastVoxelShaderCompositeFunction2()
{
...
void vtkVolumeRayCastVoxelShaderCompositeFunction2::SpecificFunctionInitialize( vtkRenderer *vtkNotUsed(renderer), vtkVolume *vtkNotUsed(volume),
...
void vtkVolumeRayCastVoxelShaderCompositeFunction2::PrintSelf( ostream &os, vtkIndent indent )
{
    ...
    {
        foreach ( VoxelShader2 *voxelShader, m_voxelShaderList )
...
const char* vtkVolumeRayCastVoxelShaderCompositeFunction2::GetCompositeMethodAsString() const
{
...
// to call.
void vtkVolumeRayCastVoxelShaderCompositeFunction2::CastRay( vtkVolumeRayCastDynamicInfo *dynamicInfo, vtkVolumeRayCastStaticInfo *staticInfo )
{
...
float vtkVolumeRayCastVoxelShaderCompositeFunction2::GetZeroOpacityThreshold( vtkVolume *volume )
{
    return volume->GetProperty()->GetScalarOpacity()->GetFirstNonZeroValue();
}


void vtkVolumeRayCastVoxelShaderCompositeFunction2::AddVoxelShader( VoxelShader2 * voxelShader )
{
...
void vtkVolumeRayCastVoxelShaderCompositeFunction2::InsertVoxelShader( int i, VoxelShader2 * voxelShader )
{
    m_voxelShaderList.insert( i, voxelShader );
}


int vtkVolumeRayCastVoxelShaderCompositeFunction2::IndexOfVoxelShader( VoxelShader2 * voxelShader )
{
    return m_voxelShaderList.indexOf( voxelShader );
}


void vtkVolumeRayCastVoxelShaderCompositeFunction2::RemoveVoxelShader( int i )
{
    m_voxelShaderList.removeAt( i );
}


void vtkVolumeRayCastVoxelShaderCompositeFunction2::RemoveVoxelShader( VoxelShader2 * voxelShader )
{
...
void vtkVolumeRayCastVoxelShaderCompositeFunction2::RemoveAllVoxelShaders()
{
    m_voxelShaderList.clear();
}


template <class T> void vtkVolumeRayCastVoxelShaderCompositeFunction2::CastRay( const T */*data*/,
...
//     const float * const GRADIENT_OPACITY_TRANSFER_FUNCTION = staticInfo->Volume->GetGradientOpacityArray();
    ...
    for ( int step = 0; step < N_STEPS && remainingOpacity > REMAINING_OPACITY; step++ )
    {
        ...
        if ( !INTERPOLATION )
        {
            for ( int i = 0; i < nShaders; i++ ) color = m_voxelShaderList.at( i )->shade( offset, direction, remainingOpacity, color );
        }
        else if ( CLASSIFY_INTERPOLATE )
        {
            ...
            for ( int j = 0; j < 8; j++ )
            {
                ...
                for ( int i = 0; i < nShaders; i++ ) tempColor = m_voxelShaderList.at( i )->shade( offsets[j], direction, remainingOpacity, tempColor );
