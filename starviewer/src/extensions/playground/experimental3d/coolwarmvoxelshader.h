...
inline HdrColor CoolWarmVoxelShader::shade(const Vector3 &position, const Vector3 &direction, const TrilinearInterpolator *interpolator, float remainingOpacity,
...
inline HdrColor CoolWarmVoxelShader::nvShade(const Vector3 &position, const Vector3 &direction, const TrilinearInterpolator *interpolator,
...
#endif // UDGCOOLWARMVOXELSHADER_H
