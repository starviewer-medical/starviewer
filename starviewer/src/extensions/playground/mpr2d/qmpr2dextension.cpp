...
void QMPR2DExtension::switchToMIPLayout( bool isMIPChecked )
{
...
void QMPR2DExtension::handleAxialViewEvents( unsigned long eventID )
{
    switch( eventID )
    {
...
void QMPR2DExtension::handleSagitalViewEvents( unsigned long eventID )
{
    switch( eventID )
    {
    case vtkCommand::LeftButtonPressEvent:
...
void QMPR2DExtension::detectAxialViewAxisActor()
{
...
void QMPR2DExtension::rotateAxialViewAxisActor()
{
...
void QMPR2DExtension::releaseAxialViewAxisActor()
{
    if( m_pickedActorReslice )
    {
...
void QMPR2DExtension::detectSagitalViewAxisActor()
{
    // obtenim el punt que s'ha clicat
    int x, y;
...
void QMPR2DExtension::rotateSagitalViewAxisActor()
{
    // obtenim el punt que s'ha clicat
    int x, y;
    x = m_sagital2DView->getEventPositionX();
...
void QMPR2DExtension::releaseSagitalViewAxisActor()
{
    if( m_pickedActorReslice )
    {
        m_pickedActorReslice->SetInterpolationModeToCubic();
...
void QMPR2DExtension::getRotationAxis( vtkPlaneSource *plane , double axis[3] )
{
    if( !plane )
        return;
...
void QMPR2DExtension::detectPushAxialViewAxisActor()
{
    // obtenim el punt que s'ha clicat
    int x, y;
    x = m_axial2DView->getEventPositionX();
...
void QMPR2DExtension::pushSagitalViewCoronalAxisActor()
{
...
void QMPR2DExtension::pushAxialViewAxisActor()
{
    this->setCursor( QCursor( Qt::ClosedHandCursor ) );
    // obtenim el punt que s'ha clicat
    int x, y;
...
void QMPR2DExtension::releasePushAxialViewAxisActor()
{
...
void QMPR2DExtension::detectPushSagitalViewAxisActor()
{
    // obtenim el punt que s'ha clicat
    int x, y;
    x = m_sagital2DView->getEventPositionX();
...
void QMPR2DExtension::pushSagitalViewAxialAxisActor()
{
    // obtenim el punt que s'ha clicat
    int x, y;
    x = m_sagital2DView->getEventPositionX();
...
void QMPR2DExtension::releasePushSagitalViewAxisActor()
{
    m_coronal2DView->refresh();
    m_pickedActorPlaneSource = 0;
    m_pickedActorReslice = 0;
...
void QMPR2DExtension::initOrientation()
{
/**
    IMPORTANT!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
void QMPR2DExtension::axialSliceUpdated( int slice )
{
...
void QMPR2DExtension::updateControls()
{
...
void QMPR2DExtension::updateIntersectionPoint()
{
...
void QMPR2DExtension::updatePlanes()
{
...
void QMPR2DExtension::updatePlane( vtkPlaneSource *planeSource , vtkImageReslice *reslice )
{
...
void QMPR2DExtension::getSagitalXVector( double x[3] )
{
...
void QMPR2DExtension::getSagitalYVector( double y[3] )
{
...
void QMPR2DExtension::getCoronalXVector( double x[3] )
{
...
void QMPR2DExtension::getAxialXVector( double x[3] )
{
...
void QMPR2DExtension::getAxialYVector( double y[3] )
{
...
void QMPR2DExtension::getCoronalYVector( double y[3] )
{
...
double QMPR2DExtension::angleInRadians( double vec1[3] , double vec2[3] )
{
    return acos( vtkMath::Dot( vec1,vec2 ) / ( vtkMath::Norm(vec1)*vtkMath::Norm(vec2) ) );
}

double QMPR2DExtension::angleInDegrees( double vec1[3] , double vec2[3] )
{
    return angleInRadians( vec1 , vec2 ) * vtkMath::DoubleRadiansToDegrees();
}

bool QMPR2DExtension::isParallel( double axis[3] )
{
...
void QMPR2DExtension::rotateMiddle( double degrees , double rotationAxis[3] ,  vtkPlaneSource* plane )
{
...
void QMPR2DExtension::rotate( double degrees , double rotationAxis[3] ,  vtkPlaneSource* plane )
{
...
void QMPR2DExtension::updateThickSlab( double value )
{
    m_thickSlab = value;
...
void QMPR2DExtension::updateThickSlab( int value )
{
