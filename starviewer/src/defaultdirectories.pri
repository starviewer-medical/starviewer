...
isEmpty(VTKLIBDIR){
    ...
    win32:VTKLIBDIR = $$SDK_INSTALL_PREFIX/VTK/6.1.0/lib
}
VTKINCLUDEDIR = $$(VTKINCLUDEDIR)
isEmpty(VTKINCLUDEDIR){
    unix:VTKINCLUDEDIR = $$SDK_INSTALL_PREFIX/include/vtk-6.1
    win32:VTKINCLUDEDIR = $$SDK_INSTALL_PREFIX/VTK/6.1.0/include/vtk-6.1
}
...
isEmpty(ITKLIBDIR){
    ...
    win32:ITKLIBDIR = $$SDK_INSTALL_PREFIX/InsightToolkit/4.7.1/lib
}
ITKINCLUDEDIR = $$(ITKINCLUDEDIR)
isEmpty(ITKINCLUDEDIR){
    unix:ITKINCLUDEDIR = $$SDK_INSTALL_PREFIX/include/ITK-4.7
    win32:ITKINCLUDEDIR = $$SDK_INSTALL_PREFIX/InsightToolkit/4.7.1/include/ITK-4.7
}
...
isEmpty(GDCMLIBDIR){
    ...
    win32:GDCMLIBDIR = $$SDK_INSTALL_PREFIX/gdcm/2.4.4/lib
}
GDCMINCLUDEDIR = $$(GDCMINCLUDEDIR)
isEmpty(GDCMINCLUDEDIR){
    unix:GDCMINCLUDEDIR = $$SDK_INSTALL_PREFIX/include/gdcm-2.4
    win32:GDCMINCLUDEDIR = $$SDK_INSTALL_PREFIX/gdcm/2.4.4/include/gdcm-2.4
}
