...
public:
    ...
    enum OperationError {DatabaseError, ErrorConnectingPacs, NoEnoughSpace, ErrorFreeingSpace, ErrorRetrieving, PatientInconsistent, MoveDestinationAETileUnknow, MoveRefusedOutOfResources};
