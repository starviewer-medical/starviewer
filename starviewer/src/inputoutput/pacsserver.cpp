...
/** Ens permet fer un echo al PACS. Per defecte per qualsevol modalitat de connexió bé sigui busca informació o descarregar imatges per defecte permet fer un  
  *echo, per comprovar si els PACS està viu  
...
/** Aquesta funció és privada. És utilitzada per especificar en el PACS, que una de les possibles operacions que volem fer amb ell és un echo. Per defecte en   
 *qualsevol modalitat de connexió podrem fer un echo
...
/** Aquesta funció privada permet configurar la connexió per a descarregar imatges al ordinador local.
  * IMPORTANT!!! Abans de connectar s'ha d'invocar la funció setLocalhostPort
