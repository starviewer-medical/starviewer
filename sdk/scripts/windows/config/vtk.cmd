set SourceDir=%SourceDirPrefix%\VTK-6.1.0
set BuildDir=%BuildDirPrefix%\VTK-6.1.0

if %BuildType% == debug (
    set CMakeBuildType=Debug
    set BuildDir=%BuildDir%-deb
    set InstallPrefix=%SdkInstallPrefix%/VTK/6.1.0d
)
if %BuildType% == release (
    set CMakeBuildType=RelWithDebInfo
    set BuildDir=%BuildDir%-rel
    set InstallPrefix=%SdkInstallPrefix%/VTK/6.1.0
)
